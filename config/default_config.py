...
class DefaultConfig:
    ...
    # PATH
    DATA_DIR_TRAIN = '/data0/lzy/indoorMIT67/train'
    DATA_DIR_VAL = '/data0/lzy/indoorMIT67/test'
    # DATA_DIR_TRAIN = '/data0/dudapeng/workspace/datasets/sun_rgbd/data_in_class/images/train'
    # DATA_DIR_VAL = '/data0/dudapeng/workspace/datasets/sun_rgbd/data_in_class/images/test'
