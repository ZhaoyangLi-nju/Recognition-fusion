...
class RESNET18_SUNRGBD_CONFIG:
    ...
    def args(self):
        ...
        args = {'ROOT_DIR': '/home/lzy/generateDepth/summary'}
        ...
        gpus = '0,2,3,1'  # gpu no. you can add more gpus with comma, e.g., '0,1,2'
        batch_size = 48
        ...
        return {
            ...
            'GENERATE_Depth_DATA': generateDepth,#add generate depth block 
