...
class DefaultConfig:
    ...
    # DATA_DIR_TRAIN = '/data0/dudapeng/workspace/datasets/sun_rgbd/data_in_class/hha/train'
    # DATA_DIR_VAL = '/data0/dudapeng/workspace/datasets/sun_rgbd/data_in_class/hha/test'
