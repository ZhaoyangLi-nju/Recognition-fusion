...
def main():
    ...
    summary_dir='/home/lzy/summary/generateDepth/'+'resnet152_train_rgb_place365_2e-3_'+str(run_id)
    ...
    train_loader = DataProvider(cfg, dataset=train_dataset,batch_size=30, shuffle=True)
    ...
    for epoch in range(0,1000):
        ...
        train(train_loader,schedulers,net_classification_1,criterion,optimizer_1,epoch,writer)
...
def train(train_loader,schedulers,net_classification_1,criterion,optimizer_1,epoch,writer):
    ...
    print("global_step:",global_all_step)
    for i, (input,target) in enumerate(train_loader):
        global_all_step+=1
        update_learning_rate(schedulers,optimizer_1,writer,epoch=global_all_step)
...
def save_checkpoint(state, CorD):
    if CorD:
        filename='resnet152_Color_1fc_2e-3_best.pth.tar'
    else:
