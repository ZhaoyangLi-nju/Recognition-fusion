...
def main():
    ...
    summary_dir='/home/lzy/summary/generateDepth/'+'train_branch_depth'+str(run_id)
    ...
    train_loader = DataProvider(cfg, dataset=train_dataset,batch_size=80, shuffle=True)
    val_loader = DataProvider(cfg, dataset=val_dataset, batch_size=20,shuffle=False)
